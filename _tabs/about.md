...
My current company is [Impersonato](https://impersonato.com/), where we build synthetic persona systems, behavioural audits, and agent workflows for teams that need to test AI products, communication, and policy before exposing real people to them.
